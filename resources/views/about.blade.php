...
@section('content')
      ...
      <!-- Modal -->
      <div id="exampleNifty3dSign" class="modal fade" role="dialog">
                        ...
                        <div class="main_home text-center">
                            <div class="col-md-12">
                                <div class="hello_slid">
                                    <div class="slid_item">
                                        <div class="home_text ">
                                            <h2 class="text-white">Welcome to <strong>EASY</strong>  </h2>
                                    ...
                                    <div class="business_items text-center">
                                        <div class="business_item">
                                            <div class="business_img">
                                                <img src="{{ asset('assets/made/images/about-img1.jpg') }}" alt="" />
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="business_item sm-m-top-50">
                                    ...
                                    <div class="business_btn">
                                        ...
                                        <a href="" class="btn btn-primary m-top-20">Buy Now</a>
                                        <button class="btn btn-outline btn-info" onclick="alert('Testing Java script')" type="button">3D Sign</button>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{ asset('assets/made/images/work-img1.jpg') }}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{ asset('assets/made/images/work-img1.jpg') }}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{ asset('assets/made/images/work-img2.jpg') }}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{ asset('assets/made/images/work-img2.jpg') }}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{ asset('assets/made/images/work-img3.jpg') }}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{ asset('assets/made/images/work-img3.jpg') }}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{ asset('assets/made/images/work-img4.jpg') }}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{ asset('assets/made/images/work-img4.jpg') }}" class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                        ...
                        <div class="main_test fix">
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix">
                                    <div class="item_img">
                                        <img class="img-circle" src="{{ asset('assets/made/images/test-img1.jpg') }}" alt="" />
                            ...
                            <div class="col-md-6">
                                <div class="test_item fix sm-m-top-30">
                                    <div class="item_img">
                                        <img class="img-circle" src="{{ asset('assets/made/images/test-img2.jpg') }}" alt="" />
                                        <i class="fa fa-quote-left"></i>
                                    </div>
                        ...
                        <div class="main_brand text-center">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img1.png') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img2.png') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img3.png') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img4.png') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img5.png') }}" alt="" />
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <div class="brand_item sm-m-top-20">
                                    <img src="{{ asset('assets/made/images/cbrand-img6.png') }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
