    ...
    <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content">
        <div class="page-brand-info">
          <div class="brand">
            <img class="brand-img" src="{{ asset('assets/images/hotelPic.png') }}" alt="...">
            <h2 class="brand-text font-size-40">Hotel</h2>
          </div>
          <p class="font-size-20">Hotel Management Application</p>
        </div>
      ...
      @csrf
        <div class="page-login-main animation-slide-right animation-duration-1">
          <div class="brand hidden-md-up">
            <img class="brand-img" src="{{ asset('assets/images/hotelPic.png') }}" alt="...">
            <h3 class="brand-text font-size-40">Tello</h3>
          </div>
